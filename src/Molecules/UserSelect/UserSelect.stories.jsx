...
export const userSelect = () => {
  ...
  return (
    <TransProvider value={translations}>
      {
        userSelects.map(({ id, label, initialState }, key) => {
          ...
          return (
            ...
            >
              ...
              <User value={3} status="success" tooltip="This jedi has been succeessfully validated by the Jedi High Council situated atop the High Council Tower of the Jedi Temple.">
                Yoda
              </User>
              <User value={4} status="info" tooltip="This pseudo-jedi isn't a real one yet">
                C3PO
              </User>
              <User value={5}>
                Luke Skywalker
